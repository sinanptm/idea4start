      ...
      <>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => setIsLogoutModalOpen(true)} className="text-destructive focus:text-destructive">
              <LogOut className="mr-2 h-4 w-4" />
              <span>Logout</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        <ConfirmLogoutModal isOpen={isLogoutModalOpen} setIsOpen={setIsLogoutModalOpen} />
      </>
    );
  }
